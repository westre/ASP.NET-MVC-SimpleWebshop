...
namespace WindesheimWebshop.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Plaatje,Naam,Omschrijving,Prijs")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Plaatje,Naam,Omschrijving,Prijs")] Product product)
        {
            if (ModelState.IsValid)
            {
